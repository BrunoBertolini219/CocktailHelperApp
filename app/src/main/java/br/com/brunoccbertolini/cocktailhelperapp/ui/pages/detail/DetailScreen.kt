...
fun DetailScreen(
    ...
    Scaffold(
        ...
        floatingActionButton = {
            if (drinkState is Resource.Success) {
        ...
        when (drinkState) {
            ...
            is Resource.Success -> {
                ...
                if (drink != null) {
                    DrinkDetail(drink = drink, modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
private fun DrinkDetail(drink: Drink, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize()
